    ...
    <div>
      <div className='navbar'>
        ...
        <img 
          ...
          src={assets.logout} 
          alt="Profile"
          onClick={handleLogout} // Directly link onClick to handleLogout
        />
      </div>
...
// Add PropTypes for the handleLogout prop
Navbar.propTypes = {
  handleLogout: PropTypes.func.isRequired, // Ensure handleLogout is passed as a function
};
